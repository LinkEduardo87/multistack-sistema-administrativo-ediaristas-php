...
Route::get('/servicos/{servico}/edit', [App\Http\Controllers\ServicoController::class, 'edit'])->name('servicos.edit');
Route::put('/servicos/{servico}', [App\Http\Controllers\ServicoController::class, 'update'])->name('servicos.update');