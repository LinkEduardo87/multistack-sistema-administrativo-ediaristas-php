                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="icone" id="icone" class="form-control">
                            ...
                            <option value="twf-cleaning-2" {{ old('icone', isset($servico) && $servico->icone ) === 'twf-cleaning-2' ? 'selected' : '' }}>Ìcone 2</option>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('servico_outros', $servico->horas_outros ?? '') }}" type="input" required class="form-control" name="horas_outros" id="horas_outros" data-mask="0" placeholder="Quantidade horas por outros">
                    </div>
                </div>
            </div>
        </fieldset>
